...
/// <summary>
/// The canonical combined schema document from the ConfigForge spec, embedded as
/// a reusable fixture. Contains a JSON Schema, a JsonForms Categorization
/// uiSchema, and the <c>x-cf</c> extension block.
/// </summary>
